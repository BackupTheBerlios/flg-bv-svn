...
public class CopyOfFLGProperties extends  JPanel implements FocusListener{
	/**
	 * 
	 */
	...
	public static void main(String[] args){
		CopyOfFLGProperties properties;
		properties= new CopyOfFLGProperties(null,args[0],new File(args[1]),args[2]);
